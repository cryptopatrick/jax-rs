    ...
    pub fn i0(&self) -> Array {
        unary_op(self, Primitive::Exp, |x| {
            ...
            if ax < 3.75 {
                ...
                let y = 3.75 / ax;
                (ax.exp() / ax.sqrt()) * (0.398_942_3 + y * (0.01328592 + y * (0.00225319 + y * (-0.00157565 + y * (0.00916281 + y * (-0.02057706 + y * (0.02635537 + y * (-0.01647633 + y * 0.00392377))))))))
            }
        })
    }
